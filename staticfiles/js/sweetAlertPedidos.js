const btnEliminarPedido = document.querySelectorAll('#btnEliminarPedido');
...
const eliminarPedido = (id) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Hacer la petición POST para eliminar el pedido la url debe coincidir con la url definida en urls.py para eliminar pedido
            fetch(`/tienda/pedidos/${id}/eliminar/`, {
                method: 'POST',
