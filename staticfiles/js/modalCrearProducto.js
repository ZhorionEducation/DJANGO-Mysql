// Modal nativo para crear producto

const btnOpenModal = document.querySelector('#btnAddProducto');
const modalOverlay = document.querySelector('#modalProducto');
const btnCloseModal = document.querySelector('#btnCloseModal');
const modalBody = document.querySelector('.modal-body');

const openModal = () => {
    // fetch es una promesa
    fetch('/tienda/productos/nuevo/', {
        headers: {
